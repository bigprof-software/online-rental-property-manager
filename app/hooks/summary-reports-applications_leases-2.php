<?php
	...
	$x = new StdClass;
	$x->TableTitle = "Leases By Property Over Time";
	...
	$config_array = array(
		'reportHash' => 'uh2omkvwpr1oqfvdt70y',
		'request' => $_REQUEST,
		'groups_array' => $groups_array,
		'override_permissions' => false,
		'title' => 'Leases By Property Over Time',
		'custom_where' => '`applications_leases`.`status`=\'Lease\'',
