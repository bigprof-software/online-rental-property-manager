...
function residence_and_rental_history_insert(&$error_message = '') {
	...
	if(!empty($_REQUEST['SelectedID'])) residence_and_rental_history_copy_children($recID, $_REQUEST['SelectedID']);
...
function residence_and_rental_history_form($selected_id = '', $AllowUpdate = 1, $AllowInsert = 1, $AllowDelete = 1, $ShowCancel = 0, $TemplateDV = '', $TemplateDVP = '') {
	...
	$templateCode .= loadView('residence_and_rental_history-ajax-cache', array('rdata' => $rdata, 'jdata' => $jdata));
