...
function property_photos_insert(&$error_message = '') {
	...
	$data = [
		...
		'photo' => Request::fileUpload('photo', [
			...
			'success' => function($name, $selected_id) {
				createThumbnail($name, getThumbnailSpecs('property_photos', 'photo', 'tv'));
				createThumbnail($name, getThumbnailSpecs('property_photos', 'photo', 'dv'));
			},
			'failure' => function($selected_id, $fileRemoved) {
				if(!isset($_REQUEST['SelectedID'])) return '';

				/* for empty upload fields, when saving a copy of an existing record, copy the original upload field */
				return existing_value('property_photos', 'photo', $_REQUEST['SelectedID']);
			},
		]),
	...
	if(!empty($_REQUEST['SelectedID'])) property_photos_copy_children($recID, $_REQUEST['SelectedID']);
...
function property_photos_form($selected_id = '', $AllowUpdate = 1, $AllowInsert = 1, $AllowDelete = 1, $ShowCancel = 0, $TemplateDV = '', $TemplateDVP = '') {
	...
	$templateCode .= loadView('property_photos-ajax-cache', array('rdata' => $rdata, 'jdata' => $jdata));
