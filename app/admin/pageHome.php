...
<section class="admin-dashboard">
	<main class="page">
		...
		<section class="row" id="panel-grid">

			<!-- Newest Updates Panel -->
			<div class="<?= $panelColClasses ?>">
			...
			<div class="<?= $panelColClasses ?>">
				<div class="panel panel-info panel--6">
					...
					<div class="panel-body" style="position: relative; overflow: hidden; height: calc(100% - 4em);">
