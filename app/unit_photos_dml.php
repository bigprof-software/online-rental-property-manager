...
function unit_photos_insert(&$error_message = '') {
	...
	$data = [
		...
		'photo' => Request::fileUpload('photo', [
			...
			'failure' => function($selected_id, $fileRemoved) {
				...
				return existing_value('unit_photos', 'photo', $_REQUEST['SelectedID']);
			},
		]),
	...
	if(!empty($_REQUEST['SelectedID'])) unit_photos_copy_children($recID, $_REQUEST['SelectedID']);
...
function unit_photos_form($selected_id = '', $AllowUpdate = 1, $AllowInsert = 1, $AllowDelete = 1, $ShowCancel = 0, $TemplateDV = '', $TemplateDVP = '') {
	...
	$filterer_unit = thisOr($_REQUEST['filterer_unit'], '');
	...
	$templateCode .= loadView('unit_photos-ajax-cache', array('rdata' => $rdata, 'jdata' => $jdata));
