...
function applicants_and_tenants_insert(&$error_message = '') {
	...
	$data = [
		...
		'driver_license_state' => Request::val('driver_license_state', ''),
		'requested_lease_term' => Request::val('requested_lease_term', ''),
	...
	if(!empty($_REQUEST['SelectedID'])) applicants_and_tenants_copy_children($recID, $_REQUEST['SelectedID']);
...
function applicants_and_tenants_form($selected_id = '', $AllowUpdate = 1, $AllowInsert = 1, $AllowDelete = 1, $ShowCancel = 0, $TemplateDV = '', $TemplateDVP = '') {
	...
	$templateCode .= loadView('applicants_and_tenants-ajax-cache', array('rdata' => $rdata, 'jdata' => $jdata));
