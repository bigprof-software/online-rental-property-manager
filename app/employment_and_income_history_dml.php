...
function employment_and_income_history_insert(&$error_message = '') {
	...
	if(!empty($_REQUEST['SelectedID'])) employment_and_income_history_copy_children($recID, $_REQUEST['SelectedID']);
...
function employment_and_income_history_form($selected_id = '', $AllowUpdate = 1, $AllowInsert = 1, $AllowDelete = 1, $ShowCancel = 0, $TemplateDV = '', $TemplateDVP = '') {
	...
	$filterer_tenant = thisOr($_REQUEST['filterer_tenant'], '');
	...
	$templateCode .= loadView('employment_and_income_history-ajax-cache', array('rdata' => $rdata, 'jdata' => $jdata));
