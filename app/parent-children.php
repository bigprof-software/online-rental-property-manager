		...
		$pcConfig = array(
			...
			'properties' => array(
				'owner' => array(
					...
					'sortable-fields' => array(0 => '`properties`.`id`', 1 => 2, 2 => 3, 3 => '`properties`.`number_of_units`', 4 => 5, 5 => 6, 6 => 7, 7 => '`properties`.`property_reserve`', 8 => 9, 9 => 10, 10 => 11, 11 => 12, 12 => 13, 13 => '`properties`.`ZIP`'),
					'records-per-page' => 10,
					'default-sort-by' => false,
					'default-sort-direction' => 'asc',
					'open-detail-view-on-click' => true,
			...
			'property_photos' => array(
				'property' => array(
					...
					'sortable-fields' => array(0 => '`property_photos`.`id`', 1 => 2, 2 => 3, 3 => 4),
					'records-per-page' => 10,
					'default-sort-by' => false,
					'default-sort-direction' => 'asc',
					'open-detail-view-on-click' => true,
			...
			'unit_photos' => array(
				'unit' => array(
					...
					'child-primary-key' => 'id',
					'child-primary-key-index' => 0,
					'tab-label' => 'Unit photos <span class="hidden child-label-unit_photos child-field-caption">(Property)</span>',
					'auto-close' => false,
					'table-icon' => 'resources/table_icons/camera_link.png',
					'display-refresh' => true,
					'display-add-new' => true,
