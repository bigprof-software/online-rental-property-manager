		...
		$pcConfig = array(
			...
			'properties' => array(   
				'owner' => array(   
					...
					'display-add-new' => true,
					'forced-where' => '',
					'display-fields' => array(1 => 'Property Name', 2 => 'Type', 3 => 'Number of units', 4 => 'Cover photo', 5 => 'Owner', 6 => 'Operating account', 7 => 'Property reserve', 10 => 'Street', 11 => 'City', 12 => 'State', 13 => 'ZIP'),
			...
			'property_photos' => array(   
				'property' => array(   
					...
					'child-primary-key' => 'id',
					'child-primary-key-index' => 0,
					'tab-label' => 'Property photos',
					'auto-close' => false,
					'table-icon' => 'resources/table_icons/camera_link.png',
					'display-refresh' => true,
					'display-add-new' => true,
					'forced-where' => '',
					'display-fields' => array(1 => 'Property', 2 => 'Photo', 3 => 'Description'),
					'display-field-names' => array(1 => 'property', 2 => 'photo', 3 => 'description'),
					'sortable-fields' => array(0 => '`property_photos`.`id`', 1 => '`property_photos`.`property`', 2 => '`property_photos`.`photo`', 3 => '`property_photos`.`description`'),
					'records-per-page' => 10,
					'default-sort-by' => false,
					'default-sort-direction' => 'asc',
					'open-detail-view-on-click' => true,
					...
					'query' => "SELECT `property_photos`.`id` as 'id', IF(    CHAR_LENGTH(`properties1`.`id`) || CHAR_LENGTH(`properties1`.`property_name`), CONCAT_WS('',   `properties1`.`id`, ' / ', `properties1`.`property_name`), '') as 'property', `property_photos`.`photo` as 'photo', `property_photos`.`description` as 'description' FROM `property_photos` LEFT JOIN `properties` as properties1 ON `properties1`.`id`=`property_photos`.`property` "
				)
			),
			'units' => array(   
				'property' => array(   
			...
			'unit_photos' => array(   
				'unit' => array(   
					...
					'forced-where' => '',
					'display-fields' => array(1 => 'Property', 2 => 'Photo', 3 => 'Description'),
					'display-field-names' => array(1 => 'unit', 2 => 'photo', 3 => 'description'),
					'sortable-fields' => array(0 => '`unit_photos`.`id`', 1 => '`unit_photos`.`unit`', 2 => '`unit_photos`.`photo`', 3 => '`unit_photos`.`description`'),
					'records-per-page' => 10,
					'default-sort-by' => false,
					'default-sort-direction' => 'asc',
					'open-detail-view-on-click' => true,
					...
					'query' => "SELECT `unit_photos`.`id` as 'id', IF(    CHAR_LENGTH(`properties1`.`property_name`) || CHAR_LENGTH(`units1`.`unit_number`), CONCAT_WS('',   `properties1`.`property_name`, ' / ', ' / ', `units1`.`unit_number`), '') as 'unit', `unit_photos`.`photo` as 'photo', `unit_photos`.`description` as 'description' FROM `unit_photos` LEFT JOIN `units` as units1 ON `units1`.`id`=`unit_photos`.`unit` LEFT JOIN `properties` as properties1 ON `properties1`.`id`=`units1`.`property` "
				)
			)
		);
